...
<head>
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL; ?>/modules/workshop/track.css?v=<?php echo time(); ?>">
</head>
<body class="font-sans antialiased text-text-main selection:bg-primary/20 selection:text-primary min-h-screen flex flex-col items-center justify-center p-6 bg-background">
