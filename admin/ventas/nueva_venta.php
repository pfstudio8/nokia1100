    ...
    <div class="container dashboard-container" style="max-width: 800px;">
        <div class="glass-card">
            <div class="header-actions" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <h2>Nueva Venta</h2>
                <a href="<?php echo $_SESSION['admin_role'] === 'admin' ? '../panel_admin.php' : '../panel_empleado.php'; ?>" class="btn-back" style="text-decoration: none; color: var(--text-muted);">Volver</a>
            </div>
        ...
        function submitSale() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = '<?php echo $_SESSION['admin_role'] === 'admin' ? '../panel_admin.php' : '../panel_empleado.php'; ?>';
                } else {
