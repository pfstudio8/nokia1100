...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nombre) || empty($marca) || empty($modelo) || empty($precio) || empty($cantidad)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO producto_detalle (id_producto, marca, modelo, descripcion, categoria) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param("issss", $id_producto, $marca, $modelo, $descripcion, $categoria);
            ...
            $nombre = $marca = $modelo = $precio = $cantidad = $descripcion = $categoria = '';
