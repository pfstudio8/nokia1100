    ...
    <div class="container dashboard-container">
        ...
        <div class="glass-card">
            <div class="dashboard-header">
                ...
                <a href="auth/logout.php" class="logout-btn" style="text-decoration: none; color: white; border-radius: 8px;">Cerrar Sesión</a>
            </div>
            ...
            <div class="employee-grid">
                ...
                <div class="employee-card">
                    <h3>Nueva Venta</h3>
                    <a href="ventas/nueva_venta.php" class="employee-link">Crear venta →</a>
                </div>

                <div class="employee-card">
                    <h3>Consultar Stock</h3>
                    <a href="inventario/inventario.php" class="employee-link">Ver inventario →</a>
                </div>
