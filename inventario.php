        ...
        <div style="margin-bottom: 3rem; width: 100%; max-width: 1000px; margin-left: auto; margin-right: auto;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; gap: 0.75rem;">
                    <a href="<?php echo $_SESSION['role'] === 'admin' ? 'panel_admin.php' : 'panel_empleado.php'; ?>" class="btn btn-outline" style="padding: 0.6rem 1.2rem; font-size: 0.85rem;">Cerrar</a>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <div class="btn-group-sm" style="justify-content: flex-end;">
                                            <a href="cambiar_estado.php?id=<?php echo $row['id_producto']; ?>" class="btn btn-sm btn-outline" style="font-size: 0.7rem; padding: 0.3rem 0.6rem;">
                                                <?php echo $row['is_active'] ? 'OCULTAR' : 'MOSTRAR'; ?>
                                            </a>
                                            <a href="admin/productos_imagenes.php?id=<?php echo $row['id_producto']; ?>" class="btn btn-sm btn-outline" style="font-size: 0.7rem; padding: 0.3rem 0.6rem;">
                                                IMAGE
                                            </a>
