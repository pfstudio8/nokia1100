...
<body>
    <div class="dashboard-container" style="padding-top: 3rem;">
        ...
        <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0;">
            ...
            <div style="display: grid; grid-template-columns: 2fr 1fr 1fr 1fr 1fr auto; gap: 1rem; align-items: end; margin-bottom: 2rem; padding-bottom: 2rem; border-bottom: 1px solid var(--border-color);">
    ...
    <script>
        ...
        function createNewProduct() {
            ...
            fetch('crear_producto_ajax.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ nombre, marca, modelo, precio })
            })
            .then(res => res.json())
            .then(data => {
                if (data.success) {
