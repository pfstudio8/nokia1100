    ...
    <nav class="navbar">
        <div class="container nav-inner">
            ...
            <div class="nav-links">
                ...
                <a href="auth/cerrar_sesion.php" class="btn btn-outline btn-sm">Cerrar Sesión</a>
            </div>
        </div>
    </nav>
    ...
    <div class="dashboard-container" style="padding-top: 3rem;">
        ...
        <div class="grid-products admin-grid-cards">
            ...
            <div class="glass-card card-admin hover-effect">
                ...
                <a href="admin_usuarios.php" class="btn btn-primary" style="width: 100%">Gestionar Usuarios</a>
            </div>

            <div class="glass-card card-admin hover-effect">
                <h3>Ventas</h3>
                <p style="color: var(--text-muted); margin-bottom: 1.5rem;">Ver transacciones y detalles.</p>
                <a href="ventas.php" class="btn btn-primary" style="width: 100%">Ver Ventas</a>
            </div>
            ...
            <div class="glass-card card-admin hover-effect">
                ...
                <div style="display: grid; gap: 0.5rem;">
                    ...
                    <a href="agregar_stock.php" class="btn btn-primary">Agregar Stock</a>
                </div>
            </div>
            ...
            <div class="glass-card card-admin hover-effect">
                ...
                <a href="graficas_ventas.php" class="btn btn-primary" style="width: 100%">Ver Gráficos</a>
            </div>
            ...
            <div class="glass-card card-admin hover-effect">
                ...
                <div style="display: grid; gap: 0.5rem;">
                    ...
                    <a href="nueva_compra.php" class="btn btn-primary">Registrar Compra</a>
                </div>
            </div>
