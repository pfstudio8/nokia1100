                    ...
                    <tbody>
                        <?php if ($result && $result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    <td style="font-weight: 600; color: var(--text-main);"><?php echo htmlspecialchars($row['nombre'] . " " . $row['apellido']); ?></td>
                                    ...
                                    <td style="text-align: right;">
                                        <a class="btn btn-sm btn-danger" href="eliminar_usuario.php?id=<?php echo $row['id_usuario']; ?>" 
